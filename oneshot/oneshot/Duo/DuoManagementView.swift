...
struct CurrentDuoSection: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            // Edit Duo — bio, photos, interests (§7 step 9, active duo)
            NavigationLink(destination: EditDuoView(duoId: duo.id, initialBio: duo.duoBio)) {
                HStack {
